...
SECRET_KEY = 'django-insecure-8_e##v0njo=l99)1^f&7dpa#5o$bx81)=f9(a4-r1raafp0&ph'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # ✅ WhiteNoise adicionado
...
# Login
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'fila_karaoke'
LOGOUT_REDIRECT_URL = 'login'

AUTH_USER_MODEL = 'fila_karaoke.CustomUser'
